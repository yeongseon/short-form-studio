...
class TestModelHealthService:
    ...
    def test_initialization_with_default_endpoints(self, health_service):
        ...
        assert health_service.endpoints["tts-qwen3"] == "http://tts-qwen3:8100"
        assert health_service.endpoints["stt-whisper"] == "http://stt-whisper:8200"
    ...
    def test_health_paths_configured(self, health_service):
        ...
        assert health_service.health_paths["tts-qwen3"] == "/health"
        assert health_service.health_paths["stt-whisper"] == "/health"
