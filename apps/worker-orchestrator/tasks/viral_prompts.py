...
NICHE_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "ssul_dc": {
        ...
        "hook_rule": "훅은 반드시 결과/행동으로 시작하세요. '어제 X했는데...' 대신 'X가 일어났습니다'로. 훅에서 궁금증을 만드되 답은 Body3에서 주세요. 반전은 예고만 하지 말고 구체적으로 서술하세요 (실제 범죄명, 금액, 사람이름, 기관명 등). '감사합니다'로 끝내지 마세요. Conclusion은 교훈이 아닌 마지막 반전 디테일(후일담, 결과)로 끝내세요.",
...
1. **HOOK (첨 3초, 12단어 이하)**: 스크롤을 멈추는 한 문장. 첨 단어가 0.5초 안에 시작.
   - ⚠️ **결과/사건으로 시작** (절대규칙): '어제', '오늘', '몇일 전에' 등 시간어로 시작 금지!
   - ✅ 올바른 예: '중고거래 나갔다가 절도범 취급받았습니다', '배달온 사람이 경찰이었습니다'
   - ❌ 틀린 예: '어제 중고거래 앱에서...', '오늘 일어난 일을...'
   - 첣 문장에 반드시 반전/결과의 힌트가 포함되어야 함
   - 질문형 훅이 가장 효과적 (12.2%)
...
- 총 나레이션이 **40초 이내**가 되도록 간결하게 작성하세요. **90-110단어 목표**.
- **섹션별 단어 예산**: Hook 10-15단어 | Body1 20-25단어 | Body2 20-25단어 | Body3 25-30단어 | Conclusion 10-15단어
...
## Hook
(1문장. **결과/사건으로 시작**. '어제/오늘/몇일전' 등 시간어 시작 금지. 10-15단어.)

## Body1
(상황 설정 — 의심이 생기기 시작한 순간. 2문장, 20-25단어.)

## Body2
(긴장 고조 — 위기/갈등의 핵심 장면. 대화체 또는 행동 묘사 포함. 2문장, 20-25단어.)

## Body3
(클라이맥스 + 반전 — 이야기의 핵심 반전을 **구체적으로** 서술. 반전을 예고만 하지 말고 실제로 풀어주세요! 2-3문장, 25-30단어.)

## Conclusion
(마지막 충격 디테일. '감사합니다' 금지, '구독/좋아요' CTA 금지. 교훈/도덕 금지. **후일담 또는 마지막 사실**로 끝내세요. 1문장, 10-15단어.)
